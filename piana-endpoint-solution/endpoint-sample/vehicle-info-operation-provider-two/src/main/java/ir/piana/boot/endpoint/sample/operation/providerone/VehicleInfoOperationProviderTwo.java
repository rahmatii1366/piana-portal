...
public class VehicleInfoOperationProviderTwo extends VehicleInfoServiceOperation {
    private final ObjectMapper objectMapper;

    @Override
    public VehicleInfoResponse doRequest(RestClientExecutor restClientExecutor, VehicleInfoRequest requestDto) throws EndpointOperationException {
