...
public class RestRequest {
    ...
    public <T> T exchange(
        ...
        RestClient restClient = applicationContext.getBean(restClientQualifiedName, RestClient.class);
        return doRequest(restClient).exchange(exchangeFunction, true);
    }

    public RestClient.ResponseSpec retrieve(ApplicationContext applicationContext) {
        RestClient restClient = applicationContext.getBean(restClientQualifiedName, RestClient.class);
        return doRequest(restClient).retrieve();
    }
